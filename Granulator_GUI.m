...
% Last Modified by GUIDE v2.5 08-Oct-2018 13:04:16
...
randframes = randperm(numframes); % create random numbers which sequece from first one (1) to number - numframes
...
%call function to run change to newsignal2, return the result (newsignal2) and output it
%to plot..
...
for currentframe = 1:numframes2
        signalindex = (currentframe-1)*hopsize+1:(currentframe-1)*hopsize+framesize;
        newsignal2(signalindex) = newsignal2(signalindex) + framematrix2(:,randframes2(currentframe))';
end
